...
xfspec.append(['nems0.xforms.load_recordings', {'input_name': 'resp', 'output_name': 'stim'}])
#xfspec.append(['nems0.preprocessing.resp_to_pc',
...
xfspec.append(['nems0.xforms.reverse_correlation', {}])
xfspec.append(['nems0.xforms.fit_basic', {}])
#xfspec.append(['nems0.xforms.reverse_correlation', {}])

#xfspec.append(['nems0.analysis.fit_pop_model.init_pop_pca', {'flip_pcs': True}])
#xfspec.append(['nems0.analysis.fit_pop_model.fit_population_iteratively',
