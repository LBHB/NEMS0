...
if use_new_stim:
    ...
    for cc in class_labels:
        sound_sets[cc] = glob.glob(f"{soundpath}/{cc}/*.wav")[:40]
...
ax[0].imshow(ctx['val']['stim'].as_continuous(),aspect='auto',origin='bottom')
ax[0].spines['top'].set_visible(False)
ax[0].spines['right'].set_visible(False)
ax[0].spines['bottom'].set_visible(False)
ax[0].spines['left'].set_visible(False)
ax[0].set_yticklabels([])
ax[0].set_ylabel('Frequency (Hz)',ha='right',rotation='horizontal')
ax[0].set_yticks([])
for aa in range(len(ax)-1):
    ax[aa+1].plot(ctx['val']['pred'].as_continuous()[aa])
    ax[aa+1].set_ylabel(class_labels[aa],ha='right',rotation='horizontal')
    ax[aa+1].spines['top'].set_visible(False)
    ax[aa+1].spines['right'].set_visible(False)
    ax[aa+1].spines['bottom'].set_visible(False)
    ax[aa+1].set_yticks([0,1])
    ax[aa+1].set_yticklabels([0,1])
    if aa != 3:
        ax[aa+1].set_xticks([])
...
for aa in range(len(ax)):
    ax[aa].plot(ctx['val']['pred'].as_continuous()[aa])
    ax[aa].set_ylabel(class_labels[aa],ha='right',rotation='horizontal')
    ax[aa].spines['top'].set_visible(False)
    ax[aa].spines['right'].set_visible(False)
    ax[aa].spines['bottom'].set_visible(False)
    ax[aa].set_yticks([0,1])
    ax[aa].set_yticklabels([0,1])

fig, ax = plt.subplots(3, 1, sharex=True, sharey=False)
for aa in range(len(ax)):
    ax[aa].plot(ctx['val']['resp'].as_continuous()[aa])
    ax[aa].set_ylabel(class_labels[aa],ha='right',rotation='horizontal')
    ax[aa].spines['top'].set_visible(False)
    ax[aa].spines['right'].set_visible(False)
    ax[aa].spines['bottom'].set_visible(False)
